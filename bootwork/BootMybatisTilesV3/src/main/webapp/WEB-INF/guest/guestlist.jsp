...
<head>
    <meta charset="UTF-8">
    <meta http-equiv="refresh" content="100;url='./list'">
                    ...
                    $.each(data, function (idx, ele) {
                        ...
                        if(ele.photos.length>0){
                            $.each(ele.photos,function (i,sphoto){
                                s+=`
                                <img class="small" src="${stpath}/\${sphoto}" data-bs-toggle="modal" data-bs-target="#myPhotoLargeModal" onclick="large_photo('\${ele.writer}','\${sphoto}')">
                                `;
                            });
                        }
