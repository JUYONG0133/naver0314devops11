            ...
            <form id="loginfrm">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-bordered">
                        <caption align="top">
                            <label>
                                <input type="checkbox" name="saveid" ${sessionScope.saveid==null or sessionScope.saveid=='no'?"":"checked"}>&nbsp;아이디저장
                            </label>
                        </caption>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="myid" class="form-control"
                                       required="required" value="${sessionScope.loginid!=null and sessionScope.saveid=='yes'?sessionScope.loginid:''}">
                            </td>
                        </tr>
                        <tr>
