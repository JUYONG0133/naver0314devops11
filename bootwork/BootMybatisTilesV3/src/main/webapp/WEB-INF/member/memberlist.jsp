        ...
        <table class="table table-bordered" style="width: 700px;">
            ...
            <c:forEach var="s"  items="${list}" >
                <tr style="text-align: center">
                    <td>${s.num}</td>
                    <td>
                        <img src="${stpath}/${s.photo}" style="width: 130px; height: 130px; border: 3px solid black" class="rounded-circle" onerror="this.src='../image/image1.png'">&nbsp;
                            ${s.name}
                    </td>
                    <td>${s.myid}</td>
                    <td>${s.hp}</td>
