...
const TwoApp = () => {
    ...
    return (
        <div>
            ...
            <label>
                <input type='radio' name='photo' defaultValue={'17'}
                       onClick={radioClick}/>신민아
            </label>&nbsp;
            <label>
                <input type='radio' name='photo' defaultValue={'18'} defaultChecked
                       onClick={radioClick}/>신세경
            </label>&nbsp;
            <label>
                <input type='radio' name='photo' defaultValue={'20'}
                       onClick={radioClick}/>유아인
            </label>&nbsp;
            <label>
                <input type='radio' name='photo' defaultValue={'15'}
                       onClick={radioClick}/>설현
            </label>&nbsp;
            <img alt='photo3' src={require(`../image/${photo}.jpg`)} style={{width: '200px', marginLeft: '100px'}}/>
        </div>
    );
};
