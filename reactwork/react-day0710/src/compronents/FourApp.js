            ...
            <table className='table table-bordered' style={{width:'300px'}}>
                ...
                <tr>
                    <td colSpan={2} align='center'>
                        <Button variant='contained' color='error' onClick={resultButtonEvent}>결과출력</Button>
                    </td>
                </tr>
                <tr style={{height:'100px'}}>
                    <td colSpan={2} align='center' style={{fontSize:'16px',whiteSpace:'pre-line',backgroundColor:'antiquewhite'}}>{result}</td>
                </tr>
                </tbody>
            </table>
        </div>
