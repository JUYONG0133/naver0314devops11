    ...
    <form action="./update" method="post">
        ...
        <table class="table table-bordered" style="width: 400px;">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control"
                           name="writer" required="required" value="${dto.writer}">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <textarea style="width: 100%;height: 120px;" name="content" required>${dto.content}</textarea>
                </td>
            </tr>
            <tr>
                <td colspan="2" align="center">
                    <button type="submit" class="btn btn-sm btn-success">게시글 수정 후 저장</button>
