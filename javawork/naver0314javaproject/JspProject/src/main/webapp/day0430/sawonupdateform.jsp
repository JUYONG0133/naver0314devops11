...
<div style="margin: 20px;width: 300px;">
    <form action="./sawonupdateinsert.jsp" method="post">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="name" class="form-control"
                           required="required" autofocus="autofocus" value="<%=dto.getName()%>">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <select class="form-select" name="buseo">
                        <%
                            String s[] = {"교육부", "인사부", "홍보부", "해외파견부"};
                            String selectedBuseo = dto.getBuseo(); // dto에서 부서 값을 가져옴

                            for (int j = 0; j < s.length; j++) {
                                if (s[j].equals(selectedBuseo)) {
                        %>
            ...
            <tr>
                ...
                <td>
                    <img src="" class="photo" onerror="this.src='../image/photo1.png'">
            ...
            <tr>
                <th width="100" class="table-danger">입사년도</th>
                <td>
            ...
            <tr>
                <td colspan="2" align="center">
                    <button type="submit" class="btn btn-outline-secondary btn-sm"
                            style="width: 80px;">사원수정후저장</button>
