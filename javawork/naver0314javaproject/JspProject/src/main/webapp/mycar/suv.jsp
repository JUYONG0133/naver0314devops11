        ...
        <div class="col-md-6 d-flex justify-content-end">
            <table class="model">
                <tr>
                    <td width="500" align="left">
                        <h5>모 델 명: 싼타페</h5>
                        <h6>기본 차량 가격 : 40,000,000</h6>

                    </td>
                    <td width="1000" align="right">
                        <img src="../santafeoption/santafe.png" alt="싼타페 이미지" style="max-width: 100%;">
                    </td>
                </tr>
            </table>
        </div>
...
<form action="./santafeaction.jsp" method="post" id="optionsForm">
    <input type="hidden" name="num" value="<%=dto.getNum()%>">
    ...
    <table class="table">
        <tr>
            ...
            <td width="150" align="center">
                <img id="wheelImage" src="../santafeoption/wheel18.jpeg" class="wheel option-img" alt="Wheel Option">
                <select class="form-select option-select" name="wheel" id="wheelSelect">
                    <option value="../santafeoption/wheel18.jpeg" data-price="0">18인치 알로이 휠 & 타이어</option>
                    <option value="../santafeoption/wheel21.jpeg" data-price="2500000">알콘 모노블록 브레이크, 21인치 블랙 휠 패키지 (+2,500,000)</option>
                </select>
            </td>
            <td width="150" align="center">
                <img id="disImage" src="../santafeoption/4_2.jpg" class="dis option-img" alt="Navigation Option">
                <select class="form-select option-select" name="dis" id="disSelect">
                    <option value="../santafeoption/4_2.jpg" data-price="0">클러스터(4.2인치 컬러LCD)</option>
                    <option value="../santafeoption/12_3.jpg" data-price="600000">클러스터(12.3인치 컬러 LCD) (+600,000)</option>
                </select>
            </td>
            <td width="150" align="center">
                <img id="ledImage" src="../santafeoption/led1.jpeg" class="led option-img" alt="Key Option">
                <select class="form-select option-select" name="led" id="ledSelect">
                    <option value="../santafeoption/led1.jpeg" data-price="0">LED 헤드램프(MFR 타입)</option>
                    <option value="../santafeoption/led2.jpeg" data-price="1000000">Full LED 헤드램프(프로젝션 타입) (+1,000,000)</option>
                </select>
            </td>
        ...
        <tr>
            <th>추가 비용:</th>
            <td colspan="5" id="totalExtraCost">
    ...
    <table class="table">
        ...
        <tr style="height: 200px;">
            <td>
                <label class="option-label">
                    <img src="../santafeoption/hud.jpeg" alt="헤드업 Option" class="option-img"  data-bs-toggle="modal" data-bs-target="#modalHBA">
                    <input type="checkbox" name="options" value="헤드업디스플레이"> 헤드업 디스플레이
                </label>
            </td>
            <td>
                <label class="option-label">
                    <img src="../santafeoption/tra.jpeg" alt="전자식 변속 칼럼 Option" class="option-img"  data-bs-toggle="modal" data-bs-target="#modalFVSA">
                    <input type="checkbox" name="options" value="전자식 변속 칼럼"> 전자식 변속 칼럼
                </label>
            </td>
            <td>
                <label class="option-label">
                    <img src="../santafeoption/220.jpeg" alt="220V인버터 Option" class="option-img"  data-bs-toggle="modal" data-bs-target="#modalISLA">
                    <input type="checkbox" name="options" value="220V인버터"> 220V인버터
                </label>
            </td>
            <td>
                <label class="option-label">
                    <img src="../santafeoption/fca1.jpeg" alt="전방 충돌방지 보조 Option" class="option-img"   data-bs-toggle="modal" data-bs-target="#modalFCA">
        ...
        <tr style="height: 200px;">
            <td>
                <label class="option-label">
                    <img src="../santafeoption/lfa.jpeg" alt="차로 유지 보조 Option" class="option-img"  data-bs-toggle="modal" data-bs-target="#modalLFA">
                    <input type="checkbox" name="options" value="차로 유지 보조"> 차로 유지 보조
                </label>
            </td>
            <td>
                <label class="option-label">
                    <img src="../santafeoption/lca.jpeg" alt="차로 이탈방지 보조 Option" class="option-img"  data-bs-toggle="modal" data-bs-target="#modalLCA">
                    <input type="checkbox" name="options" value="차로 이탈방지 보조"> 차로 이탈방지 보조
                </label>
            </td>
            <td>
                <label class="option-label">
                    <img src="../santafeoption/daw.jpeg" alt="운전자 주의 경고 Option" class="option-img"  data-bs-toggle="modal" data-bs-target="#modalDAW">
                    <input type="checkbox" name="options" value="운전자 주의 경고"> 운전자 주의 경고
                </label>
            </td>
            <td>
                <label class="option-label">
                    <img src="../santafeoption/bca1.jpeg" alt="후측방 충돌방지 보조 Option" class="option-img"  data-bs-toggle="modal" data-bs-target="#modalBCA">
    ...
    $(document).ready(function() {
        // 이미지를 클릭하면 모달에 이미지 표시
            ...
            $("#disSelect").change(function () {
                ...
                $("#disImage").attr("src", navImgSrc);
                updateTotalExtraCost();
            });

            // 키 선택 시 이미지 변경
            $("#ledSelect").change(function () {
                let selectedKeyOption = $(this).find('option:selected');
                let keyImgSrc = selectedKeyOption.val();
                $("#ledImage").attr("src", keyImgSrc);
                updateTotalExtraCost();
            });

        $("#phoneSelect").change(function () {
            let selectedphoneOption = $(this).find('option:selected');
            let phoneImgSrc = selectedphoneOption.val();
            $("#phoneImage").attr("src", phoneImgSrc);
            updateTotalExtraCost();
        });
        ...
        function updateTotalExtraCost() {
            ...
            // 내비게이션 선택 추가 비용 계산
            let navExtraPrice = parseInt($("#disSelect option:selected").data('price')) || 0;
            totalCost += navExtraPrice;

            // 키 선택 추가 비용 계산
            let keyExtraPrice = parseInt($("#ledSelect option:selected").data('price')) || 0;
            totalCost += keyExtraPrice;

            let phoneExtraPrice = parseInt($("#phoneSelect option:selected").data('price')) || 0;
            totalCost += phoneExtraPrice;
